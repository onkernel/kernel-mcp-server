...
export async function GET(request: NextRequest): Promise<NextResponse> {
  ...
  // We don't normalize redirect_uri - clients must use the form they registered with
  // New registrations automatically include both localhost and 127.0.0.1 forms
  searchParams.forEach((value, key) => {
    if (key !== "org_id") {
